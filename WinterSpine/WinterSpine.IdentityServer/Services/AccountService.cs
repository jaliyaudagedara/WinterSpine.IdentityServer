...
namespace WinterSpine.IdentityServer.Services
{
    public class AccountService
    {
        ...
        public async Task<LoginViewModel> BuildLoginViewModelAsync(string returnUrl)
        {
            ...
            if (AccountOptions.IsWindowsAuthenticationEnabled)
            {
            ...
            return new LoginViewModel
            {
                ...
                IsEnableLocalLogin = allowLocal && AccountOptions.IsAllowLocalLogin,
                ReturnUrl = returnUrl,
                Username = context?.LoginHint,
        ...
        {
            var vm = new LogoutViewModel { LogoutId = logoutId, IsShowLogoutPrompt = AccountOptions.IsShowLogoutPrompt };
